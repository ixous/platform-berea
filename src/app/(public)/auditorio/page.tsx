          ...
          <div className="mx-auto max-w-4xl">
            <div className="relative overflow-hidden rounded-2xl bg-berea-navy p-12 text-center">
              ...
              <div className="relative">
                ...
                <p className="mx-auto mt-4 max-w-2xl text-lg leading-relaxed text-white/70">
                  ...
                  desarrollando un nuevo auditorio principal que albergará a nuestra congregación y
                  permitirá seguir alcanzando más vidas para Cristo.
                </p>
              </div>
            </div>
            ...
            <div className="mt-14 grid gap-8 sm:grid-cols-3">
              {[
                ...
                <div
                  key={item.title}
                  className="rounded-xl border border-berea-border/40 bg-white p-8 text-center shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-berea-gold/30 hover:shadow-lg hover:shadow-berea-gold/5"
                >
            ...
            <div className="mt-12 rounded-xl border border-berea-border/60 bg-berea-light/50 p-8 text-center backdrop-blur-sm">
              <p className="text-xs font-medium tracking-wider text-berea-muted/60 uppercase">
