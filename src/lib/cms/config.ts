...
export const entityConfigs: Record<string, EntityDef> = {
  ...
  contact: {
    ...
    icon: "Phone",
    listSearchFields: ["address", "email", "phone", "churchName"],
    listColumns: ["churchName", "phone", "email"],
    softDelete: false,
    singleRecord: true,
    defaultSort: { field: "updatedAt", dir: "desc" },
    fields: [
      ...
      {
        name: "scheduleNote",
        label: "Nota de horarios",
        type: "text",
        help: "Ej: Duración aproximada: 2 horas",
      },
      {
        name: "socialMedia",
      ...
      { name: "ctaTitle", label: "Título del CTA", type: "text" },
      { name: "ctaDescription", label: "Descripción del CTA", type: "textarea" },
      { name: "ctaButtonText", label: "Texto del botón CTA", type: "text" },
      { name: "ctaButtonHref", label: "Enlace del botón CTA", type: "url" },
    ],
  },
  ...
  institutionalSections: {
    entityType: "institutionalSections",
    schemaTable: "institutionalSections",
    displayName: "Sección Institucional",
    pluralName: "Secciones Institucionales",
    permission: "pages.manage",
    icon: "Layout",
    listSearchFields: ["title", "content"],
    listColumns: ["title", "pageSlug", "status", "displayOrder"],
    softDelete: false,
    statusField: "status",
    statusTransitions: {
      draft: ["published", "archived"],
    ...
    fields: [
      {
        ...
        type: "text",
        required: true,
        help: "Slug de la página (ej: quienes-somos)",
      },
      {
        name: "sectionKey",
        ...
        type: "text",
        required: true,
        help: "Identificador único (ej: brief-history)",
      },
      { name: "title", label: "Título", type: "text" },
      { name: "content", label: "Contenido", type: "richtext" },
      { name: "imageUrl", label: "Imagen (URL)", type: "image" },
      { name: "buttonText", label: "Texto del botón", type: "text" },
      { name: "buttonHref", label: "Enlace del botón", type: "url" },
      { name: "displayOrder", label: "Orden", type: "number" },
      {
        name: "visible",
        label: "Visible",
  ...
  doctrines: {
    entityType: "doctrines",
    schemaTable: "doctrines",
    displayName: "Doctrina",
    pluralName: "Doctrinas",
    permission: "pages.manage",
    icon: "Book",
    listSearchFields: ["title", "subtitle", "content"],
    listColumns: ["title", "status", "displayOrder"],
    softDelete: false,
    statusField: "status",
    statusTransitions: {
      draft: ["published", "archived"],
  ...
  institutionalPages: {
    entityType: "institutionalPages",
    schemaTable: "institutionalPages",
    displayName: "Página Institucional",
    pluralName: "Páginas Institucionales",
    permission: "pages.manage",
    icon: "FileText",
    listSearchFields: ["slug", "metaTitle", "bannerTitle"],
    listColumns: ["slug", "bannerTitle", "published"],
    softDelete: false,
    ...
    fields: [
      {
        ...
        type: "text",
        required: true,
        help: "Identificador único (ej: quienes-somos)",
      },
      { name: "metaTitle", label: "Título SEO", type: "text" },
      { name: "metaDescription", label: "Descripción SEO", type: "textarea" },
      { name: "bannerTitle", label: "Título del banner", type: "text" },
      { name: "bannerSubtitle", label: "Subtítulo del banner", type: "text" },
      { name: "bannerImage", label: "Imagen del banner", type: "image" },
      {
        name: "published",
        label: "Publicado",
        type: "select",
